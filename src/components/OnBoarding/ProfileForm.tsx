...
const ProfileForm = ({
	...
	personalInfo: User;
	setPersonalInfo: Dispatch<React.SetStateAction<User | null>>;
}) => {
		...
		<Grid container spacing={4}>
			...
			<Grid xs={12} md={6}>
				<Autocomplete
					...
					options={genders}
					renderInput={(params): JSX.Element => <TextField {...params} fullWidth label="Gender" name="gender" />}
					onChange={(e, values) => {
			...
			<Grid xs={12} md={6}>
				<Autocomplete
					...
					options={grades}
					renderInput={(params): JSX.Element => <TextField {...params} fullWidth label="Grade" name="grade" />}
					onChange={(e, values) => {
			...
			<Grid xs={12} md={6}>
				<Autocomplete
					...
					options={colleges}
					renderInput={(params): JSX.Element => <TextField {...params} fullWidth label="College" name="college" />}
					onChange={(e, values) => {
			...
			<Grid xs={12} md={6}>
				<Autocomplete
					...
					options={majors}
					renderInput={(params): JSX.Element => <TextField {...params} fullWidth label="Major" name="major" />}
					onChange={(e, values) => {
